...
class MLP:
    ...
    def __init__(self, n_layers=1, layer_dims=[0, 0]):
        '''
        Args:  
        ...
        if n_layers == 0:
            raise ValueError("OutOfBounds: n_layers must be atleast 1 (The output layer)")
    ...
    def save_model(self, file_path):
        ...
        for i, layer in enumerate(self.layers):
            ...
            model_params['n_layers'] = len(self.layers)
    ...
    def load_model(self, file_path):
        ...
        self.__init__(model_params['n_layers'], [1 for _ in range(model_params['n_layers'] + 1)])
...
if __name__ == '__main__':
    ...
    model = MLP(n_layers=3, layer_dims=[784, 20, 20, 10])

    model.train(X_train, y_train)
    model.save_model("models/np/MNIST_MLP_2")